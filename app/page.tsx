        ...
        <div className="mx-auto w-full max-w-7xl space-y-12 box-border overflow-x-hidden">
          <section className="relative overflow-hidden rounded-2xl sm:rounded-[2.5rem] border border-white/10 bg-slate-950/72 p-4 sm:p-8 sm:p-11 shadow-[0_52px_140px_rgba(15,23,42,0.36)] backdrop-blur-3xl w-full max-w-full box-sizing">
            ...
            <div className="grid gap-4 sm:gap-8 lg:grid-cols-[1.35fr_0.9fr] items-start w-full">
              {/* Left Content */}
              <div className="space-y-4 sm:space-y-7 relative z-10 w-full max-w-full overflow-hidden">
                ...
                <div className="space-y-4 sm:space-y-6 w-full max-w-full overflow-hidden">
                  <h1 className="hero-h1 w-full max-w-full overflow-hidden">
                    <div className="text-white whitespace-normal break-words">Найдём</div>
                    <div className="bg-gradient-to-r from-purple-300 via-pink-300 to-fuchsia-300 bg-clip-text text-transparent break-words">идеальный подарок</div>
                    <div className="text-white drop-shadow-[0_0_22px_rgba(255,255,255,0.18)] whitespace-normal break-words">за 30 секунд</div>
                  </h1>
                  <p className="text-base sm:text-lg leading-7 sm:leading-8 text-slate-300 w-full max-w-full font-light">Ответьте на 5 вопросов и получите 10 персональных идей с ценами, вау‑рейтингом и ссылками на товары.</p>
                </div>

                <div className="flex flex-col gap-3 w-full pt-2 sm:flex-row sm:items-center sm:gap-4">
                  ...
                  <a href="#how-it-works" className="inline-flex items-center justify-center rounded-full border border-white/15 bg-white/5 px-4 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm font-semibold text-slate-200 transition hover:bg-white/10 hover:border-white/20 backdrop-blur-sm w-full sm:w-auto">Как это работает</a>
                </div>
