          ...
          <div className="glass rounded-3xl p-6 space-y-4">
            ...
            {status ? (
              <div className="grid gap-3 sm:grid-cols-2">
                <StatusRow label="ID клиента" value={status.hasClientId ? 'ключ найден' : 'ключ отсутствует'} />
                <StatusRow label="Секрет клиента" value={status.hasClientSecret ? 'ключ найден' : 'ключ отсутствует'} />
